...
PACKAGE ?= helm-kube-prometheus-stack
XRD_DIR := apis/kubeprometheusstacks
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/kubeprometheusstacks/standard.yaml
...
render\:%:
	@example="examples/kubeprometheusstacks/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
